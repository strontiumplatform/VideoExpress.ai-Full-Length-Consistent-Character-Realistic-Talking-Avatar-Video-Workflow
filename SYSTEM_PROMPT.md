  ...
  c. Click "Create Video". A SECOND dialog opens: "Create Lipsync Audio".
     THIS is where the speech goes:
       - "Video Prompt" (textarea[name="prompt"] INSIDE THIS DIALOG): one line saying
         ...
         performance is directed in plain natural language — ANY emotion, ANY
         phrasing, including physical performance:
         ...
         Write the delivery the way a director would speak it. Match the scene's
         emotion tag from the wave. NO dialogue text here.
